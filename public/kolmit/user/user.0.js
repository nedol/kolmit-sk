...
var app = (function () {
    ...
    class SignalingChannel {
      constructor(url) {
        ...
        if (!this.ws) this.ws = new WebSocket(this.url);
    ...
    class RTCUser extends RTCBase {
      constructor(abonent, type, em, uid) {
        ...
        (async () => {
          this.host = await (await fetch('./host.json')).json();
      ...
      OnMessage(data) {
        ...
        if (data.operators) {
          if (
            data.operators[that.abonent] &&
            data.operators[that.abonent].abonent === that.abonent
          ) {
            if (data.operators[that.abonent].status === 'offer') ; else if (
    ...
    /* src\user\modal\Profile.svelte generated by Svelte v3.40.2 */
    ...
    function create_fragment$l(ctx) {
    	...
    	let div6;
    	let h2;
    	let t2_value = /*dict*/ ctx[8]['How to introduce you?'][/*lang*/ ctx[7]] + "";
    	let t2;
    	let t3;
    	let div2;
    	let div0;
    	...
    	let t11;
    	let button;
    	let t12_value = /*dict*/ ctx[8]['Save and Close'][/*lang*/ ctx[7]] + "";
    	let t12;
    	let mounted;
    	let dispose;
    	...
    	return {
    		c() {
    			...
    			attr(input0, "placeholder", input0_placeholder_value = /*dict*/ ctx[8]['input user name *'][/*lang*/ ctx[7]]);
    			input0.required = true;
    			set_style(div0, "width", "250px");
    			attr(input1, "type", "email");
    			attr(input1, "id", "email");
    			attr(input1, "class", "form-control");
    			attr(input1, "placeholder", input1_placeholder_value = /*dict*/ ctx[8]['input email address'][/*lang*/ ctx[7]]);
    			input1.required = true;
    			set_style(input1, "width", "100%");
    			set_style(div1, "flex", "1");
    			set_style(div2, "display", "flex");
    			set_style(div2, "flex-direction", "column");
    			if (!src_url_equal(img.src, img_src_value = /*src*/ ctx[2])) attr(img, "src", img_src_value);
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen(img, "click", /*OnClickUpload*/ ctx[12]),
    					listen(input2, "change", /*OnChangeFile*/ ctx[10]),
    					listen(input2, "change", /*input2_change_handler*/ ctx[19]),
    					listen(button, "click", /*OnClickSend*/ ctx[11]),
    					action_destroyer(/*setForm*/ ctx[9].call(null, div7))
    				];
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*lang*/ 128 && t2_value !== (t2_value = /*dict*/ ctx[8]['How to introduce you?'][/*lang*/ ctx[7]] + "")) set_data(t2, t2_value);

    			if (dirty & /*lang*/ 128 && input0_placeholder_value !== (input0_placeholder_value = /*dict*/ ctx[8]['input user name *'][/*lang*/ ctx[7]])) {
    			...
    			if (dirty & /*lang*/ 128 && input1_placeholder_value !== (input1_placeholder_value = /*dict*/ ctx[8]['input email address'][/*lang*/ ctx[7]])) {
    			...
    			if (dirty & /*lang*/ 128 && t12_value !== (t12_value = /*dict*/ ctx[8]['Save and Close'][/*lang*/ ctx[7]] + "")) set_data(t12, t12_value);
    		},
    		i: noop,
    		o: noop,
    		d(detaching) {
    ...
    function instance$k($$self, $$props, $$invalidate) {
    	let $dicts;
    	let $langs;
    	component_subscribe($$self, dicts, $$value => $$invalidate(21, $dicts = $$value));
    	component_subscribe($$self, langs, $$value => $$invalidate(22, $langs = $$value));
    	let { profile } = $$props;
    	let { selected } = $$props;
    	let form;
    	...
    	async function setForm(form) {
    		...
    		if (localStorage.getItem('kolmit_abonent')) {
    			...
    			$$invalidate(3, name = item.name);
    			$$invalidate(4, email = item.email);
    			$$invalidate(2, src = item.src);
    		}
    	}
    			...
    			let data = await loadImage(
    				...
    				function (img, data) {
    					if (img.type === "error") {
    						...
    						$$invalidate(2, src = img.toDataURL());
    	...
    	function OnClickSend() {
    		localStorage.setItem('kolmit_abonent', JSON.stringify({ id: window.id, src, name, email }));
    		$$invalidate(14, selected = '');
    		$$invalidate(13, profile = false);
    	}
    	...
    	$$self.$$set = $$props => {
    		if ('profile' in $$props) $$invalidate(13, profile = $$props.profile);
    ...
    class Profile extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$k, create_fragment$l, safe_not_equal, { profile: 13, selected: 14 });
    	}
    }
    ...
    /* src\user\CallButtonUser.svelte generated by Svelte v3.40.2 */
    ...
    function create_fragment$k(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(g, "class", "currentLayer svelte-hfaciq");
    			set_style(g, "stroke", "black");
    			set_style(g, "stroke-width", "10px");
    			attr(svg, "class", "callButton svelte-hfaciq");
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen(div, "long-press", stop_propagation(prevent_default(function () {
    ...
    ***************************************************************************** */
    ...
    /* src\user\DropdownList.svelte generated by Svelte v3.40.2 */
    ...
    /* src\user\Video.local.svelte generated by Svelte v3.40.2 */
    ...
    function create_fragment$7(ctx) {
    	...
    	return {
    		c() {
    			...
    			set_style(video, "bottom", "18px");
    			set_style(video, "right", "0px");
    			set_style(video, "max-height", "25%");
    ...
    /* src\user\Video.remote.svelte generated by Svelte v3.40.2 */
    ...
    /* src\user\Download.svelte generated by Svelte v3.40.2 */
    ...
    /* src\user\Audio.local.svelte generated by Svelte v3.40.2 */
    ...
    /* src\user\Audio.remote.svelte generated by Svelte v3.40.2 */
    ...
    /* src\user\RecordedVideo.svelte generated by Svelte v3.40.2 */
    ...
    /* src\user\User.svelte generated by Svelte v3.40.2 */
    ...
    function create_if_block_2(ctx) {
    	...
    	function profile_1_profile_binding(value) {
    		/*profile_1_profile_binding*/ ctx[13](value);
    	}

    	function profile_1_selected_binding(value) {
    		/*profile_1_selected_binding*/ ctx[14](value);
    	}

    	let profile_1_props = {};

    	if (/*profile*/ ctx[2] !== void 0) {
    		profile_1_props.profile = /*profile*/ ctx[2];
    	}
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			if (!updating_profile && dirty[0] & /*profile*/ 4) {
    				updating_profile = true;
    				profile_1_changes.profile = /*profile*/ ctx[2];
    ...
    function create_if_block_1(ctx) {
    	...
    	return {
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(svg, "click", /*OnClickVideoButton*/ ctx[12]);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    // (430:0) <VideoRemote slot="remote" {...remote.video}>
    ...
    function create_if_block(ctx) {
    	...
    	function dropdownlist_display_binding(value) {
    		/*dropdownlist_display_binding*/ ctx[18](value);
    	}

    	function dropdownlist_selected_binding(value) {
    		/*dropdownlist_selected_binding*/ ctx[19](value);
    	}

    	function dropdownlist_list_binding(value) {
    		/*dropdownlist_list_binding*/ ctx[20](value);
    	}

    	function dropdownlist_status_binding(value) {
    		/*dropdownlist_status_binding*/ ctx[21](value);
    	}
    ...
    function create_fragment$1(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = /*profile*/ ctx[2] && create_if_block_2(ctx);

    	function callbuttonuser_status_binding(value) {
    		/*callbuttonuser_status_binding*/ ctx[15](value);
    	}

    	let callbuttonuser_props = { OnLongPress };
    	...
    	callbuttonuser.$on("click", /*OnClickCallButton*/ ctx[11]);
    	callbuttonuser.$on("mute", /*OnMute*/ ctx[10]);
    	const audiolocal_spread_levels = [/*local*/ ctx[6].audio];

    	function audiolocal_paused_binding(value) {
    		/*audiolocal_paused_binding*/ ctx[16](value);
    	}
    	...
    	function audioremote_srcObject_binding(value) {
    		/*audioremote_srcObject_binding*/ ctx[17](value);
    	}
    	...
    	let if_block1 = /*video_button_display*/ ctx[3] && create_if_block_1(ctx);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	async function OnClickCallButton() {
    		...
    		switch (status) {
    			...
    			case 'call':
    				...
    				$$invalidate(3, video_button_display = 'none');
    				clearInterval(inter);
    				window.user.Hangup();
    				break;
    			case 'talk':
    	...
    	function OnClickVideoButton() {
    		...
    		$$invalidate(3, video_button_display = false);
    	...
    	function OnMessage(data) {
    		...
    		if (data.func === 'talk') {
    			$$invalidate(1, status = 'talk');
    			clearInterval(inter);
    			$$invalidate(3, video_button_display = true);
    			$$invalidate(6, local.audio.paused = true, local);
    			$$invalidate(7, remote.audio.muted = false, remote);
    			$$invalidate(3, video_button_display = 'block');
    	...
    	function profile_1_profile_binding(value) {
    		profile = value;
    		(($$invalidate(2, profile), $$invalidate(0, selected)), $$invalidate(33, event));
    	}

    	function profile_1_selected_binding(value) {
    		selected = value;
    		($$invalidate(0, selected), $$invalidate(33, event));
    	}

    	function callbuttonuser_status_binding(value) {
    		status = value;
    		((($$invalidate(1, status), $$invalidate(2, profile)), $$invalidate(0, selected)), $$invalidate(33, event));
    	}
    	...
    	function audioremote_srcObject_binding(value) {
    		if ($$self.$$.not_equal(remote.audio.srcObject, value)) {
    			...
    			((($$invalidate(7, remote), $$invalidate(2, profile)), $$invalidate(0, selected)), $$invalidate(33, event));
    		}
    	}
    	...
    	function dropdownlist_display_binding(value) {
    		if ($$self.$$.not_equal(select.display, value)) {
    			...
    			(($$invalidate(8, select), $$invalidate(0, selected)), $$invalidate(33, event));
    		}
    	}
